...
TByte* UartMessageMemoryManager::allocate(EMessageId messageId)
{
    ...
    switch (messageId)
    {
        ...
        ALLOCATE_MACRO(SetHeaterTemperatureInFeedbackModeRequest)
        ALLOCATE_MACRO(SetHeaterTemperatureInFeedbackModeResponse)
		ALLOCATE_MACRO(SetNewDeviceModeADS1248Request)
		ALLOCATE_MACRO(SetMaximumAllowedTemperatureRequest)
        ALLOCATE_MACRO(SetMaximumAllowedTemperatureResponse)
...
void UartMessageMemoryManager::deallocate(TByte* memoryPtr, EMessageId messageId)
{
    ...
    switch (messageId)
    {
        ...
        DEALLOCATE_MACRO(SetHeaterTemperatureInFeedbackModeRequest)
        DEALLOCATE_MACRO(SetHeaterTemperatureInFeedbackModeResponse)
		DEALLOCATE_MACRO(SetMaximumAllowedTemperatureRequest)
		DEALLOCATE_MACRO(SetMaximumAllowedTemperatureResponse)
...
u16 UartMessageMemoryManager::getLength(EMessageId messageId)
{
    switch (messageId)
    {
        ...
        GET_LENGTH_MACRO(SetHeaterTemperatureInFeedbackModeRequest)
        GET_LENGTH_MACRO(SetHeaterTemperatureInFeedbackModeResponse)
		GET_LENGTH_MACRO(SetMaximumAllowedTemperatureRequest)
		GET_LENGTH_MACRO(SetMaximumAllowedTemperatureResponse)
